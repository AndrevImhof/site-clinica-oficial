...
const profissionais: Prof[] = [
  ...
  },
  {
    ...
    formacao: 'Graduação em Psicologia pelo Centro Universitário Estácio de Santa Catarina. Formação em Clínica Existencialista. Pós-graduação: Sexualidade e Psicologia; Saúde Mental e Dependência Química; e Saúde Coletiva. Cursando Especialização em Clínica Fenomenológica.',
    publico: 'Adolescentes a partir de 14 anos, Adultos e Idosos. Atendimento Online.',
    demandas: 'Processos de luto, dificuldades interpessoais, transtornos de ansiedade e depressão, fobias, ideação suicida, estresse pós-traumático, relacionamentos abusivos, acompanhamento LGBTQIA+, desenvolvimento de habilidades sociais.',
    atendimento: 'Unimed, Cartão Acesso + Fácil (Unimed), Saudesc, CELOS, Elosaúde, ABEPOM, CASACARESC, SC Saúde, Sim Saúde, GEAP, FUSEX, Petrobras, Saúde Caixa e Particular.',
  ...
  },
  {
    ...
    metodo: 'Psicanálise',
    filtros: ['Psicanálise'],
    formacao: 'Graduado pelo Centro Universitário Filadélfia (UNIFIL) Londrina -PR, Especialista em Dependência Química.',
    publico: 'Atende Adolescentes a partir 18 anos, Adultos e Idosos. Atendimento On-line e Presencial.',
    demandas: 'Atende casos de ansiedade, depressão, transtorno obsessivo compulsivo.',
  ...
  },
  {
    ...
    metodo: 'Psicanálise',
    filtros: ['Psicanálise'],
    formacao: 'UFSC - Graduação e Mestrado em Psicologia. UNISUL - Doutorado em Ciências da Linguagem. Maiêutica Fpolis - Formação em Psicanálise.',
    publico: 'Atende crianças a partir de 07 anos de idade, Adolescente, Adultos, Casais e Idoso. Atendimento Presencial.',
  ...
  },
  {
    ...
    publico: 'Atendo crianças a partir de 2 anos, adolescentes, adultos, famílias e casais.',
  ...
  },
  {
    ...
    metodo: 'Terapia Cognitivo Comportamental (TCC) e ABA',
    filtros: ['TCC', 'ABA'],
    formacao: 'Graduação em Psicologia pela Universidade Federal Fluminense RJ; Pós graduação em Autismo pela FAVENI; Curso em terapia ABA no autismo para pais e aplicadores pela Academia do Autismo; Pós graduação em Desenvolvimento Infantil - ESHA/SPERJ - Niterói - RJ; Qualificação em ABA - Creative Ideias.',
    publico: 'Atende Crianças a partir de 02 (dois) anos, Adolescentes, Adultos e Casais. Atendimento Presencial e On-line.',
    demandas: 'Transtorno do Espectro Autista (ABA), TDAH e demais transtornos de neurodesenvolvimento, dificuldades de aprendizagem, Transtornos de ansiedade, transtornos de depressão, transtornos de humor, transtorno de personalidade, transtornos alimentares, luto, bipolaridade, fobias em geral, transtorno obsessivo compulsivo, estresse, pânico, dificuldades de se relacionar, desenvolvimento de habilidades sociais, estresse pós traumático, gênero e sexualidade, ideação suicida, autoestima, autoconhecimento, conflitos familiares e de relacionamentos, desenvolvimento infantil; Avaliação Psicológica, Avaliação para cirurgia bariátrica, Avaliação para esterilização/anticoncepção (laqueadura), Avaliação para esterilização/anticoncepção (vasectomia), Orientação profissional.',
    atendimento: 'Unimed, Cartão Acesso + Fácil (Unimed), Saudesc, CELOS, Elosaúde, ABEPOM, CASACARESC, SC Saúde, Sim Saúde, GEAP, FUSEX, Petrobras, Saúde Caixa e Particular.',
  ...
  },
  {
    ...
    metodo: 'Psicanálise',
    filtros: ['Psicanálise'],
    formacao: 'Formação em Psicologia na Universidade UNOESC, com pós Especialização em Tanatologia e Clínica.',
    publico: 'Atende Crianças a partir de 12 anos, Adolescentes, Adultos e Casais. Atendimento On-line.',
    demandas: 'Transtornos de Humor e Emocionais: Depressão, Transtornos de Ansiedade, Bipolaridade; Processos de Luto e Perdas: Lutos em Geral, Questões Relacionadas à Perda de Emprego, Mudança de Emprego ou Mudança de Cidade, Separação e Divórcio; Desenvolvimento Pessoal e Profissional: Preparação para Aposentadoria, Orientação Profissional; Questões de Gênero e Sexualidade: Identidade de Gênero, Questões Relacionadas à Sexualidade; Transtornos Psicológicos e Psiquiátricos: Ideação Suicida, Transtorno Obsessivo-Compulsivo (TOC), Transtorno de Personalidade Borderline, Síndrome de Burnout, Transtorno do Espectro Bipolar; Violência e Traumas: Violência Doméstica, Traumas Psicológicos e Emocionais, Violência contra Mulheres, Crianças e Adolescentes, Abuso Emocional, Físico e Sexual; Relacionamentos e Conflitos Interpessoais: Conflitos Conjugais e Amorosos, Questões Familiares e Complicações Relacionadas; Saúde Mental Materna: Depressão Pós-Parto, Ajustamento ao Período Puerperal; Dependências e Vícios: Dependência Química, Alcoolismo; Outras Demandas: Fobias, Transtornos Alimentares (Anorexia, Bulimia), Transtornos do Sono; Avaliações Psicológicas Específicas (como para cirurgia bariátrica, esterilização/anticoncepção).',
    atendimento: 'Unimed, Cartão Acesso + Fácil (Unimed), Saudesc, CELOS, Elosaúde, ABEPOM, CASACARESC, Sim Saúde, SC Saúde, GEAP, FUSEX, Petrobras, Saúde Caixa e Particular.',
  ...
  },
  {
    ...
    publico: 'Atende Adolescentes a partir dos 16 anos, Adultos e Casais. Atendimento On-line.',
    demandas: 'Ansiedade: preocupação excessiva, medos, pânico. Depressão. Inibição: Dificuldades em iniciar, manter ou terminar relacionamentos; Dificuldades no desenvolvimento profissional. Fobias: Fobia social - medo de falar em público, permanecer em espaços, de interagir com pessoas, etc. Conflitos familiares, alienação parental. Sofrimentos relacionados a imagem corporal. Transtornos Alimentares: (Bulimia, Anorexia). Transtornos do Sono (insônia primária e secundária). Transtorno pós traumático: após acidentes ou violência sofrida. Avaliação para cirurgia bariátrica.',
    atendimento: 'Unimed, Cartão Acesso + Fácil (Unimed), Saudesc, CELOS, Elosaúde, ABEPOM, CASACARESC, Sim Saúde, GEAP, FUSEX, Petrobras, Saúde Caixa e Particular.',
  ...
  },
  {
    ...
    metodo: 'Terapia Cognitivo Comportamental (TCC)',
    filtros: ['TCC'],
    formacao: 'Formada em Psicologia pela ULBRA - Universidade Luterana do Brasil; Pós-Graduação em Terapia Cognitivo Comportamental com certificação Internacional pelo CBI Of Miami; MBA em Gestão de Recursos Humanos pela Universidade Veiga de Almeida - RJ; Cursos de Transtornos de Humor, Saúde Mental, Transtornos Alimentares, Dependência Química, estados terminais de câncer e Transplante de Medula Óssea.',
  ...
  },
  {
    ...
    filtros: ['TCC', 'Neuropsicologia'],
    formacao: 'Formada em psicologia pela instituição Estácio de Sá; cursando pós graduação em terapia cognitivo comportamental, se especializando em psicodinâmica; Pós-Graduação Lato Sensu em Neuropsicologia com ênfase em reabilitação cognitiva na IPOG.',
    publico: 'Atende Crianças a partir dos 05 anos, Adolescentes, Adultos até 20 anos. Atendimento On-line e Presencial.',
    demandas: 'Atendo crianças e adolescentes com Transtorno de Déficit de Atenção e Hiperatividade (TDAH), Transtorno do Espectro Autista (TEA), Síndrome de Down e outros transtornos do neurodesenvolvimento, como transtornos de aprendizagem (dislexia, discalculia), transtorno do desenvolvimento da coordenação, transtornos de comunicação, atrasos globais do desenvolvimento e dificuldades emocionais e comportamentais. Meu trabalho foca na reabilitação neuropsicológica, ajudando a desenvolver habilidades cognitivas, emocionais e sociais essenciais para a autonomia e qualidade de vida.',
    atendimento: 'Unimed, Cartão Acesso + Fácil (Unimed), Saudesc, CELOS, Elosaúde, ABEPOM, CASACARESC, Sim Saúde, GEAP, FUSEX, Petrobras, Saúde Caixa e Particular.',
  ...
  },
  {
    ...
    metodo: 'Terapia Cognitivo Comportamental (TCC)',
    filtros: ['TCC'],
    formacao: 'Graduação em Psicologia pelo Centro Universitário Estácio de Santa Catarina.',
  ...
  },
  {
    ...
    metodo: 'Fenomenológico Existencial',
    filtros: ['Fenomenologia'],
    formacao: 'Formação em Psicologia pela Pontifícia Universidade Católica do Paraná - PUC/PR; Pós Graduada em Psicologia Clínica Fenomenológico Existencial pela Unipar.',
    publico: 'Adolescente a partir dos 15 anos, Adulto e Idoso. Atendimento Presencial e On-line.',
    demandas: 'Atendo adultos que estão vivendo diferentes desafios emocionais e existenciais, oferecendo um espaço de escuta, acolhimento e reflexão. Trabalho com demandas como ansiedade e depressão, luto, ideação suicida, estresse e esgotamento emocional, incluindo estresse pós-traumático. Também acompanho questões relacionadas a relacionamentos, conflitos familiares, dificuldades no trabalho e nos estudos (faculdade, cursos e período pré-vestibular). Atendo ainda demandas ligadas à maternidade, dificuldades em lidar com a raiva, sofrimento emocional persistente, crises de identidade e questões relacionadas à sexualidade. O processo terapêutico é um espaço para compreender o que está sendo vivido, fortalecer recursos internos e encontrar formas mais conscientes e saudáveis de lidar com a própria história e com o momento atual.',
    atendimento: 'Unimed, Cartão Acesso + Fácil (Unimed), Saudesc, CELOS, Elosaúde, ABEPOM, CASACARESC, Sim Saúde, GEAP, FUSEX, Petrobras, Saúde Caixa e Particular.',
  ...
  },
  {
    ...
    publico: 'Atende Criança a partir 12, Adolescente e Adulto.',
  ...
  {
    nome: 'Kamilly da Costa',
    registro: '',
    metodo: 'Neuropsicopedagogia',
    filtros: ['Neuropsicologia'],
    formacao: 'Graduada em Pedagogia e Pós-graduada - Lato Sensu - em Neuropsicopedagogia e Psicanalise Clínica; Gestão Escolar pela FMP; especialista em Atendimento Educacional Especializado (AEE), Educação Especial, Práticas Inclusiva pela Faculdade Dom Bosco, e Pós graduada pela Universidade Federal do Piauí em Ciências Humanas. Atualmente graduanda do curso de Serviço Social/UFSC - Universidade Federal de Santa Catarina.',
    publico: 'Atende Crianças a partir de 02 anos, Adolescentes, Adultos.',
    demandas: 'Muitas pessoas enfrentam dificuldades de aprendizado, como dislexia, TDAH e outras condições. A neuropsicopedagogia oferece estratégias específicas para atender a essas necessidades. Implementando metodologias e estratégias de intervenções pensadas na especificidade e condição do paciente.',
    atendimento: 'Unimed, Cartão Acesso + Fácil (Unimed), Saudesc e Particular.',
    foto: '/equipe/kamilly_psico.avif',
  },
  {
    nome: 'Keli Ferro',
    ...
    atendimento: 'Unimed, Cartão Acesso + Fácil (Unimed), Saudesc, CELOS, ABEPOM, CASACARESC, GEAP, FUSEX, Petrobras, Saúde Caixa e Particular.',
  ...
  },
  {
    ...
    filtros: ['Fenomenologia'],
    formacao: 'Psicóloga com formação na abordagem Existencialista Sartreana; Perita Judicial no Tribunal de Justiça de Santa Catarina (Vara da Família); Pós-graduação: Tanatologia (Psicologia da Morte e do Morrer); Especialização: Suicidologia, Desastres Aéreos, Desastres Naturais, Diversidade Sexual.',
    publico: 'Atende Adolescentes a partir de 16 anos, Adultos, Idosos. Atendimento Presencial e On-line.',
    demandas: 'Especializada em oferecer suporte a pessoas em momentos de perda, luto (luto social, luto simbólico, luto parental, luto conjugal, luto por suicídio, luto por morte súbita, luto por morte violenta, luto por separação ou divórcio, luto por perda da saúde, luto pela perda do pet, luto por perda funcional, luto migratório, luto institucional). Síndrome do Ninho Vazio, Mães Atípicas, Mães de Anjos e Mães Neurodivergentes, Ansiedade, Depressão, Medo, Fobia Social. Dependência Emocional, Crises Existenciais, Traumas, Estresse, Estresse Pós-Traumático, Dependência Química, Alcoolismo, Violência Doméstica, Violências Sexuais, Distúrbios Alimentares (anorexia, bulimia), Transtorno de Imagem, Transtorno de Humor, Bipolar, Borderline, Abandono de Incapaz, Dificuldades na Dinâmica Conjugal e Afetiva (Sofrimento no vínculo amoroso, Feridas emocionais na relação, Dores no campo afetivo, Vivências de frustração relacional, Divórcio/Separação), Burnout, Bullying, Pais em Processo de Filiação Adotiva, Aspectos relacionados à Identidade de Gênero e à Orientação Sexual, Desafios no Reconhecimento e Afirmação da Identidade.',
    atendimento: 'Unimed, Cartão Acesso + Fácil (Unimed), Saudesc, CELOS, Elosaúde, ABEPOM, CASACARESC, SC Saúde, Sim Saúde, GEAP, FUSEX, Petrobras, Saúde Caixa e Particular.',
  ...
  },
  {
    ...
    metodo: 'Analista Junguiana',
    filtros: ['Junguiana'],
    formacao: 'Graduação em Psicologia pela Universidade de Uberaba – UNIUBE (2013).',
    publico: 'Atende Adolescentes a partir de 16 anos, Adultos e Idosos.',
    demandas: 'Autoconhecimento, autoestima, bem-estar emocional e desenvolvimento de habilidades pessoais; construção e ressignificação de projetos de vida; Orientação Profissional e de Carreira — com ênfase na primeira escolha profissional (vestibular/ensino médio) e também apoio para quem opta por caminhos técnicos, formação profissional não universitária ou transição de carreira; inclui elaboração de currículo e preparação para o mercado de trabalho; traumas e experiências adversas, como negligência emocional, abandono, rejeição, violência psicológica ou instabilidade familiar; dificuldade de vinculação, dependência emocional, baixa autoestima, padrões relacionais disfuncionais, angústia, insegurança, sintomas psicossomáticos, conflitos relacionais, sentimentos de vazio existencial, dificuldades nos relacionamentos e situações de transição ou tomada de decisão; transtornos de ansiedade: TAG (Transtorno de Ansiedade Generalizada), TOC (Transtorno Obsessivo-Compulsivo), fobia social, transtorno de pânico/crises de pânico; transtornos do humor e bipolaridade: TDM (Transtorno Depressivo Maior) e DP (Distimia); transtornos relacionados ao déficit de atenção: TDA/TDAH; transtornos do sono: insônia e alterações no padrão de sono relacionadas à ansiedade, estresse ou desregulação emocional; transtornos alimentares: anorexia, bulimia e compulsão alimentar; transtornos de personalidade; transtornos relacionados a trauma e estresse, incluindo TEPT (Transtorno de Estresse Pós-Traumático); esgotamento profissional (burnout).',
    atendimento: 'Unimed, Cartão Acesso + Fácil (Unimed), Saudesc, CELOS, Elosaúde, ABEPOM, CASACARESC, Sim Saúde, GEAP, FUSEX, Petrobras, Saúde Caixa e Particular.',
  ...
  },
  {
    ...
    metodo: 'Psicanálise',
    filtros: ['Psicanálise', 'ABA'],
    formacao: 'Psicologia - Universidade Federal de Santa Catarina (2017); Formação em Psicanálise - Maiêutica Florianópolis (2019); Cursando Intervenção ABA para autismo e deficiências intelectuais (2024).',
    publico: 'Atende Crianças a partir de 05 anos, Adultos, Casais. Atendimento Presencial e On-line. Opção de atendimento em inglês e espanhol.',
    demandas: 'Ansiedade, Depressão, TDAH, Transtorno do Espectro Autista (TEA), Transtorno do Espectro Autista (método ABA), Transtorno Obsessivo Compulsivo, Transtornos Alimentares, Ideação suicida, Problemas comportamentais, familiares e de relacionamento, planejamento de vida e carreira, entre outros.',
    atendimento: 'Unimed, Cartão Acesso + Fácil (Unimed), Saudesc, CELOS, Elosaúde, ABEPOM, CASACARESC, Sim Saúde, GEAP, FUSEX, Petrobras, Saúde Caixa e Particular.',
  ...
  },
  {
    ...
    demandas: 'Transtornos de ansiedade, depressão, crise de Pânico, TOC, Fobias, comportamento alimentar, autoestima, relacionamento. Realização de Avaliação Psicológica, Orientação Profissional, Avaliação para cirurgia bariátrica, Avaliação para esterilização/anticoncepção (laqueadura), Avaliação para esterilização/anticoncepção (vasectomia).',
    atendimento: 'Unimed, Cartão Acesso + Fácil (Unimed), Saudesc, CELOS, Elosaúde, ABEPOM, CASACARESC, Sim Saúde, GEAP, FUSEX, Petrobras, Saúde Caixa e Particular.',
  ...
  },
  {
    ...
    metodo: 'Terapia Cognitivo Comportamental (TCC), Neuropsicologia e Hipnose Clínica',
    filtros: ['TCC', 'Neuropsicologia'],
